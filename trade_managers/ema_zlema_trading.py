import numpy as np
from indicators.trend_indicators import exponential_moving_average, zero_lag_ema


def ema_zlema_trading(ticker, df, sma_fast_period, sma_medium_period, sma_slow_period, ema_period):  # long
